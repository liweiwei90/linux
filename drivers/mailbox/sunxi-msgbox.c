...
/*
 * Allwinner A733 msgbox driver for Linux.
 */
...
#ifndef clear_bits
#define clear_bits(addr, mask)          writel(readl(addr) & ~(mask), (addr))
#endif
 ...
 *     --------------------------------------------
 */
static const struct sunxi_msgbox_hwdata sun60iw2_hwdata = {
	.processors_max = 2,
	.channels_max = 4,
	.fifo_msg_max = 8,
	.mbox_num_chans = 4,
...
static const struct of_device_id sunxi_msgbox_of_match[] = {
	{ .compatible = "allwinner,sun60iw2-msgbox", .data = &sun60iw2_hwdata},
	{},
};
