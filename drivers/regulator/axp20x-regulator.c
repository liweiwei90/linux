...
#define AXP318_DCDC1_NUM_VOLTAGES	32	/* 5-bit vsel; 0x00-0x1c valid */
...
#define AXP318_LDO_NUM_VOLTAGES		32	/* 5-bit vsel; 0x00-0x1d valid */
#define AXP318_ELDO_NUM_VOLTAGES	64	/* 6-bit vsel; 0x00-0x28 valid */
...
/* Load switch that reports a fixed voltage (needed for MMC OCR). */
#define AXP_DESC_SW_FIXED(_family, _id, _match, _supply, _volt, _ereg, _emask)	\
	[_family##_##_id] = {							\
		.name		= (_match),					\
		.supply_name	= (_supply),					\
		.of_match	= of_match_ptr(_match),				\
...
static const struct regulator_ops axp20x_ops_sw_voltage = {
	.enable			= regulator_enable_regmap,
	.disable		= regulator_disable_regmap,
	.is_enabled		= regulator_is_enabled_regmap,
	.list_voltage		= regulator_list_voltage_linear,
...
static const struct linear_range axp318_dcdc1_ranges[] = {
	/* AXP318W / AXP8191 DCDC1: 1.0V-3.8V, 100mV/step (sel 0x00-0x1c) */
	REGULATOR_LINEAR_RANGE(1000000, 0x0, 0x1c, 100000),
	/* Reserved vsel 0x1d-0x1f: hardware clamps at 3.8V */
	REGULATOR_LINEAR_RANGE(3800000, 0x1d, 0x1f, 0),
};
...
/* AXP318W / AXP8191 ALDO/BLDO/CLDO/DLDO: 0.5V-3.4V, 100mV/step */
static const struct linear_range axp318_ldo_ranges[] = {
	REGULATOR_LINEAR_RANGE(500000, 0x0, 0x1d, 100000),
	REGULATOR_LINEAR_RANGE(3400000, 0x1e, 0x1f, 0),
};

/* AXP318W / AXP8191 ELDO: 0.5V-1.5V, 25mV/step */
static const struct linear_range axp318_eldo_ranges[] = {
	REGULATOR_LINEAR_RANGE(500000, 0, 40, 25000),
	REGULATOR_LINEAR_RANGE(1500000, 41, 63, 0),
};

static const struct regulator_desc axp318_regulators[] = {
	AXP_DESC_RANGES(AXP318, DCDC1, "dcdc1", "vin19",
			axp318_dcdc1_ranges, AXP318_DCDC1_NUM_VOLTAGES,
